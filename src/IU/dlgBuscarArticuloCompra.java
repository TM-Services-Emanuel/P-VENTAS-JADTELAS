...
public class dlgBuscarArticuloCompra extends javax.swing.JDialog {
    ...
    public static void Renders() {
        dlgBuscarArticuloCompra.tbDetalle.getColumnModel().getColumn(15).setCellRenderer(new RenderDecimal());
        dlgBuscarArticuloCompra.tbDetalle.getColumnModel().getColumn(13).setCellRenderer(new RenderDecimal());
    }
    ...
    private void initComponents() {
        ...
        tbDetalle.setFont(new java.awt.Font("Roboto", 0, 10)); // NOI18N
        ...
        tbDetalle.setToolTipText("Doble Clic para seleccionar Producto");
