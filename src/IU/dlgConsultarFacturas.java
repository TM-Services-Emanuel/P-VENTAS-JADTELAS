...
public class dlgConsultarFacturas extends javax.swing.JDialog {
   ...
   // public static ResultSet rss;
    ...
    private void CalcularValores(){
        ...
        lbTotal.setText("VENTA ACTIVA: "+df.format(Integer.valueOf(facturado.replace(".", "").replace(",", ""))));
        lbAnulados.setText("VENTA ANULADA: "+df.format(Integer.valueOf(anulado.replace(".", "").replace(",", ""))));
    }
    ...
    jPanel5Layout.setHorizontalGroup(
        ...
        .addGroup(jPanel5Layout.createSequentialGroup()
            ...
            .addComponent(txtDesde, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            .addComponent(dcDesde, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addContainerGap())
    );
