...
//        //Lanzar el Joptionpane
    ...
    public static double ingresarNumerosV( double ca)//JoptionPane que solo acepte numeros
    {
        double numero=ca;
        ...
        {
            try {
                numero = Double.parseDouble(JOptionPane.showInputDialog("Ingrese la nueva cantidad", 1));
                if (numero <= 0) {
                    numero = Double.parseDouble(JOptionPane.showInputDialog("Ingrese la nueva cantidad", 1));
                } else {
                    ...
                    if (numero > Ar.getStock()) {
                        numero = Double.parseDouble(JOptionPane.showInputDialog("Ingrese la nueva cantidad", Ar.getStock()));
                    }   
                    //bandera = true;
                }
