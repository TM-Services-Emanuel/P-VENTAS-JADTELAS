...
public class Caja {
    ...
    public Caja(String fechaI,String horaI,String fechaF,String horaF, int caInicial, int caFinal, int caDiferencia, String usuarioI, String usuarioF) {
        this.fechaI = fechaI;
        this.horaI = horaI;
        this.fechaF = fechaF;
        this.horaF = horaF;
    ...
    public Caja(int caId, String fechaF, String horaF, int caDiferencia, int caFinal, String usuarioF){
        this.caId = caId;
        this.fechaF = fechaF;
        this.horaF = horaF;
        this.caDiferencia = caDiferencia;
