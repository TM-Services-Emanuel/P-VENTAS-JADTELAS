...
public class GestionarCaja {
    ...
    public static String addCaja(Caja caja) {
        ...
        sql.append(caja.getUsuarioI()).append("','");
        sql.append(caja.getUsuarioF()).append("','S')");
    ...
    public static Caja busCaja(String cod) {
        ...
        if (filaObt != null) {
            ...
            caj.setCaDiferencia(Integer.parseInt(filaObt[7].toString()));
            caj.setUsuarioI(String.valueOf(filaObt[8].toString()));
            caj.setUsuarioF(String.valueOf(filaObt[9].toString()));
            caj.setIndicador(String.valueOf(filaObt[10].toString()));
